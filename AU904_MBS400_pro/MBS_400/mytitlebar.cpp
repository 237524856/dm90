...
#define BUTTON_HEIGHT 31*m_Magnification         // 按钮高度;
#define BUTTON_WIDTH 31*m_Magnification          // 按钮宽度;
    ...
    , m_isTransparent(false)
{
    ...
    imageLabel->resize(154*m_Magnification,49*m_Magnification);
    imageLabel->move(10*m_Magnification,10*m_Magnification);
...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMin->setStyleSheet(
                                "QPushButton{border-image:url(:/image/images/mbs400_min_button.png) 0 62 0 0;}"
                                "QPushButton:hover{border-image:url(:/image/images/mbs400_min_button.png) 0 31 0 31;}"
                                "QPushButton:pressed{border-image:url(:/image/images/mbs400_min_button.png) 0 0 0 62;}"
    ...
    m_pButtonClose->setStyleSheet(
                "QPushButton{border-image:url(:/image/images/mbs400_close_button.png) 0 62 0 0;}"
                "QPushButton:hover{border-image:url(:/image/images/mbs400_close_button.png) 0 31 0 31;}"
                "QPushButton:pressed{border-image:url(:/image/images/mbs400_close_button.png) 0 0 0 62;}"
                "QPushButton:focus{outline: none;}"
                                  );
