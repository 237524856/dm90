...
recoderAudio::recoderAudio(QXYSeries *series,QObject *parent) : QIODevice(parent),
    m_series(series)
{
 ...
 * @return
 */
qint64 recoderAudio::readData(char *data, qint64 maxlen)
{
//    Q_UNUSED(data)
//    Q_UNUSED(maxlen)
    qDebug()<<"yangyu-----------"<<maxlen;
    return maxlen;
}
 ...
 * @return
 */
qint64 recoderAudio::writeData(const char *data, qint64 len)
{
    //写入文件中
